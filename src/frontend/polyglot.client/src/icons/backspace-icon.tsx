export const BackspaceIcon = ({height, width}: { height: number, width: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill="none">
      <path opacity="0.5"
            ...
            className="stroke-primary-100" strokeWidth="1.5"/>
      <path d="M15.5 9.50002L10.5 14.5M10.5 9.5L15.5 14.5" className="stroke-primary" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>);
};
