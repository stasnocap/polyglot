...
internal static class SeedDataExtensions
{
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        InsertExercises(connection);
        InsertLessonExercises(connection);
    ...
    private static void InsertLessonExercises(IDbConnection connection)
    {
    ...
    private static void InsertExercises(IDbConnection connection)
    {
    ...
    private static void InsertLessons(IDbConnection connection)
    {
